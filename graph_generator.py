...
def inject_block(srcfilename, dstfilename, fanfilename, idolfilename, num_block, num_fan, num_idol, density,
                 camouflage):
    N = 0
    fw = open(dstfilename, 'w')
...
def inject_staircase(srcfilename, dstfilename, fanfilename, idolfilename, num_stair, num_fan, num_idol, num_shared_idol,
                     density):
    N = 0
    fw = open(dstfilename, 'w')
    fr = open(srcfilename, 'r')
...
if __name__ == '__main__':
    ...
    inject_block('graph_random_powerlaw', 'graph_two_blocks', 'injectfans_two_blocks', 'injectidols_two_blocks', 2, 100,
                 100, 0.8, 0.0)
    inject_block('graph_random_powerlaw', 'graph_two_blocks_camou', 'injectfans_two_blocks_camou',
                 'injectidols_two_blocks_camou', 2, 100, 100, 0.8, 0.3)
    inject_staircase('graph_random_powerlaw', 'graph_staircase', 'injectfans_staircase', 'injectidols_staircase', 3,
                     100, 100, 20, 0.8)
